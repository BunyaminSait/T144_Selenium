...
public class C03_driverManageTimeoutsMethodlari {
    public static void main(String[] args) {
        ...
        /*
         ...
         ve kodlarin calismasini bizim belirledigimiz surede durdur

         testi ilk defa yazarken test adimlarini gormemiz
         veya bir sunum yaptigimizda sunum yaptigimiz kisilere adimlari gostermemiz acisindan
         kullanimi uygundur

         Bazen'de bilgisayarımızın veya internetimizin hizindan dolayi
