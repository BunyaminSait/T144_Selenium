...
public class C03_RelativeLocator {
    public static void main(String[] args) throws InterruptedException {
        ...
        } else System.out.println("1. relative locater testi FAILED");
        ...
        } else System.out.println("2. relative locater testi FAILED");

        // 2. RelativeLocator icin
        driver.get("https://testotomasyonu.com/relativeLocators");
        Thread.sleep(2000);
        ...
        } else System.out.println("3. relative locater testi FAILED");
        ...
        if (urunIsimElementi.getText().equals(expectedIsim)){
            System.out.println("4. relative locater testi PASSED");
        } else System.out.println("4. relative locater testi FAILED");
        ...
        /*
            ...
            driver apple kulaklik icin "StaleElementReferenceException" veriyor

            Bu exception daha once locate edilmis ama artik kullanilamayan elemnt oldugunda
            karsimiza cikar
        ...
        if (urunIsimElementi.getText().equals(expectedIsim)){
            System.out.println("5. relative locater testi PASSED");
        } else System.out.println("5. relative locater testi FAILED");
